        ...
        <tr>
            <td>
                <table class="brandbartable" width="100%" border="0" align="center" cellpadding="6" cellspacing="0" style="background-color:#ffffff;">
                    <tr>
                        <td align="left" style="background-color:#ffffff;"><a href="http://www.activeglobalcaregiver.com"><img src="${logoactiveglobalcaregiver}" alt="" class="logo" border="0"/></a>
                        </td>
        ...
        <tr>
            <td style="background-color:#FFFFFF;font-size:13px;font-family:arial;line-height:20px">
                ...
                <table class="contenttable" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td class="contenttd" style="padding:10px 15px;border-bottom:1px solid #f2f2f2;">
                                ...
                                <tr>
                                    <td style="width: 100px;" valign="top">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td>
													<img src="${photo}"  style="max-height: 200px" width="100%"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td style="padding: 3px 10px;">
                                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" style="border-bottom: 1px solid #f2f2f2;">
                                                        <tr>
                                                            <td style="width: 60%;">
                                                                <p style="font:normal 13px/1.5em arial;">${expectedSalary}</p>
                                                            </td>
                                                            <td style="width: 40%;">
                                                                <p style="font:normal 13px/1.5em arial;">
                                                                    ${salary}
                            ...
                            <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                <img src="${header-about}"/>
                            </p>
                            <p class="ptext" style="font:normal 13px/1.5em arial;">
                                ${caregiver.about}
                            </p>
                            <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                <img src="${header-education}"/>
                            </p>
                            <p class="ptext" style="font:normal 13px/1.5em arial;">
                                 ${caregiver.education}
                            </p>
                            <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                <img src="${header-certified}"/>
                            </p>
                            <p class="ptext" style="font:normal 13px/1.5em arial;">
                            	${caregiver.certifiedCpr}
                            </p>
                            <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                <img src="${header-nursing-exp}"/>
                            </p>
                            <p class="ptext" style="font:normal 13px/1.5em arial;">
                                ${caregiver.specialities}
                            </p>
                            <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                <img src="${header-hobbies}"/>
                            </p>
                            <p class="ptext" style="font:normal 13px/1.5em arial;">
                                ${caregiver.hobbies}
                            </p>
                    ...
                    <tr>
                        <td style="padding:20px 15px 20px 15px;font-family: Arial, Helvetica, sans-serif;font-size: 14px;font-weight: bold;color: #666666; font-style: italic; text-align: justify;">Disclaimer:Disclaimer: This biodata has been prepared by our team, to the best of our knowledge, based on the information provided by the candidate. While some information was checked during our interviewing process, we are unable to verify 100% of the information provided by the candidate.
                    ...
                    <tr>
                        <td style="padding:20px 15px 20px 15px;font-family: Arial, Helvetica, sans-serif;font-size: 10px;font-weight: normal;color: #666666;">Employee Registration Number:${registrationNumber} </td>
                    </tr>
                    <tr>
