<div bgcolor="#ffffff" style="margin:0px;background-color:#ffffff;font-family: Arial, Helvetica, sans-serif;color:#333333;font-size:13px;">
                        ...
                        <tr>
                            <td class="contenttd" style="padding:10px 15px;border-bottom:1px solid #f2f2f2;">
                                    ...
                                    <tr>
                                        <td style="width: 100px;" valign="top">
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr>
                                                    <td>
                                                        <img src="cid:photo"  style="max-height: 200px" width="100%"/>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                    <img src="cid:header-about"/>
                                </p>
                                <p class="ptext" style="font:normal 13px/1.5em arial;">
                                    ${caregiver.about}
                                </p>
                                <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                    <img src="cid:header-education"/>
                                </p>
                                <p class="ptext" style="font:normal 13px/1.5em arial;">
                                    ${caregiver.education}
                                </p>
                                <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                    <img src="cid:header-certified"/>
                                </p>
                                <p class="ptext" style="font:normal 13px/1.5em arial;">
                                    ${caregiver.certifiedCpr}
                                </p>
                                <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                    <img src="cid:header-nursing-exp"/>
                                </p>
                                <p class="ptext" style="font:normal 13px/1.5em arial;">
                                    ${caregiver.specialities}
                                </p>
                                <p class="ptext" style="font:normal 14px/1.5em arial;text-transform: uppercase;font-weight: bold;">
                                    <img src="cid:header-hobbies"/>
                                </p>
                                <p class="ptext" style="font:normal 13px/1.5em arial;">
                                    ${caregiver.hobbies}
                                </p>
